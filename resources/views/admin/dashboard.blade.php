...
<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Silahkan pilih tombol "Log out" di bawah.</div>
...
@section('js')
    <script type="text/javascript" src="{{ asset('../asset/admin/vendor/chart.js/Chart.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('../asset/admin/js/demo/chart-area-demo.js') }}"></script>
    <script type="text/javascript" src="{{ asset('../asset/admin/js/demo/chart-pie-demo.js') }}"></script> 
@endsection