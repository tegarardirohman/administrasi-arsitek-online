...
<li class="nav-item">
    <a class="nav-link" href="#" data-toggle="collapse show" data-target="#collapseProyek" aria-expanded="true"
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <div class="p-2">
                        <a href="/admin/proyek/berjalan">Proyek</a> / {{ $post->pry_nama }}
                    </div>
                </div>
                        ...
                        @foreach($hasil_desain as $data)
                            @if($item->desain_id == $data->id_hasil_desain)
                                <tr>
                                    ...
                                    @if($data->det_status == 'proses')
                                        <td><span class="badge badge-warning">Proses</span></td>
                                    @elseif($data->det_status == 'revisi')
                                        <td><span class="badge badge-danger">Revisi</span></td>
                                    @elseif($data->det_status == 'dikirim')
                                        <td><span class="badge badge-primary">Dikirim</span></td>
                                    @else
                                        <td><span class="badge badge-success">Selesai</span></td>
                                    @endif
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="d-flex">
                            <form action="/admin/detail_proyek/DeleteFile" method="POST">
                            @csrf
                            @method('PUT')
