...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/cs/">
            ...
            <div class="sidebar-brand-text mx-3">Costumer Service</div>
        </a>
        ...
        <li class="nav-item active">
                ...
                <div id="collapseProyek" class="collapse show" aria-labelledby="headingTwo"
                        ...
                        <div class="card border-left-success shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                            Jumlah Pendapatan (bulan)</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">Rp. 180.000.000</div>
                                    </div>
                                    <div class="col-auto">
                                        <i class="fas fa-comments fa-2x text-gray-300"></i>
                                    </div>
...
@section('js')
    <script type="text/javascript" src="{{ asset('../asset/cs/vendor/chart.js/Chart.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('../asset/cs/js/demo/chart-area-demo.js') }}"></script>
    <script type="text/javascript" src="{{ asset('../asset/cs/js/demo/chart-pie-demo.js') }}"></script> 
@endsection